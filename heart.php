...
<div>
  ...
  <section style="height: 50px; margin-top: 50px; margin-bottom: -70px;">
      <h1 style="text-align: center; font-family: Georgia, serif; color: #494747;">Heart</h1>
  </section>
  <div class="container" style="margin-top: 120px; z-index: -1; border-color: none;">
    <div id="message"></div>
    <div class="row mt-2 pb-3">
      <?php
        include 'config.php';
        $stmt = $conn->prepare('SELECT * FROM cake WHERE brand_name ="heart";');
        $stmt->execute();
